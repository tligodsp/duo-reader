...
import { Form, Col, Button, Alert, InputGroup, Modal } from "react-bootstrap";
...
const AddManga = props => {
  const validate = values => {
    ...
    if (values.publishYear && !/^\d+$/.test(values.publishYear)) {
      ...
      values.publishYear &&
      parseInt(values.publishYear, 10) > d.getFullYear()
    ) {
          ...
          <Form onSubmit={formik.handleSubmit}>
            ...
            <Form.Group>
              ...
              <InputGroup>
                ...
                />
                <InputGroup.Append>
                  <Button variant="secondary" onClick={onCoverButtonClick}>
                    ...
                  </Button>
                </InputGroup.Append>
              </InputGroup>
